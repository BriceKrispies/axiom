...
use crate::physics_crucible::crucible_report::CrucibleReport;
use crate::physics_crucible::debug_geometry::{palette, RenderInstance};
...
mod tests {
    use super::*;
    use crate::physics_crucible::crucible_report::{BodyState, ContactInfo, StepCounts};
