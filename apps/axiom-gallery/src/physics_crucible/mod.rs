...
use crate::physics_crucible::crucible_scenario::Station;
...
pub use crate::physics_crucible::crucible_report::CrucibleReport;
pub use crate::physics_crucible::physics_crucible_app::{build_physics_crucible, Crucible};
...
mod tests {
    ...
    fn all_stations_are_present_in_canonical_order() {
        ...
        assert_eq!(ids, crate::physics_crucible::crucible_station::CrucibleStation::ALL.to_vec());
    }
