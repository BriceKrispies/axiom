...
pub const PENALTY_PALETTE: [PenaltyMaterial; 28] = [
    ...
    lit(PenaltyMaterialId::CrowdMutedColors, "crowd muted colors", Rgba::rgb(0.46, 0.34, 0.38)),
    lit(PenaltyMaterialId::CrowdMutedColorsAltA, "crowd muted colors (alt a)", Rgba::rgb(0.34, 0.40, 0.50)),
    lit(PenaltyMaterialId::CrowdMutedColorsAltB, "crowd muted colors (alt b)", Rgba::rgb(0.50, 0.46, 0.34)),
