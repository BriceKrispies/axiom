//! Scalar and small-array interpolation curves shared across the generia app:
//! plain linear interpolation and the two smoothstep forms used by the
//! visual-target diorama builder (`visual_target/build.rs`) and the scatter
//! placer (`visual_target/scatter.rs`).
//!
