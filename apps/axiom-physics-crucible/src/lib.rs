...
/// Backend-comparison entry: render the crucible three ways at once — WebGPU,
...
pub fn physics_crucible_compare_start(canvas_a: &str, canvas_b: &str, canvas_c: &str) {
    console_error_panic_hook::set_once();
    physics_crucible_app::crucible_app().run_compare([canvas_a, canvas_b, canvas_c]);
}
