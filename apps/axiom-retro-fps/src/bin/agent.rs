...
use axiom_retro_fps::agent::{Action, AgentSession, Observation};
use axiom_retro_fps::perception::RetroFpsPerceiver;
...
fn run_perception_demo(ticks: u32) {
    println!("axiom-retro_fps perception demo — the agent sees and tracks ({ticks} ticks)");
