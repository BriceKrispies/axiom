...
use axiom_roomed_puzzle::actor_state::ActorState;
use axiom_roomed_puzzle::game_command::PuzzleCommand;
use axiom_roomed_puzzle::{level_codec, Direction, PuzzleGameState, LEVEL_001_TOML};
...
fn encode_actor(out: &mut Vec<u8>, a: &ActorState) {
    ...
    out.push(match a.kind {
        axiom_roomed_puzzle::actor_state::ActorKind::Player => 0,
        axiom_roomed_puzzle::actor_state::ActorKind::Ghost => 1,
    });
