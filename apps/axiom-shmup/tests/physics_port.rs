...
//! recomputations — see `apps/shmup/tests/core_port.rs` for the
...
use axiom_shmup::physics::bvh::{Aabb, StaticWorld};
use axiom_shmup::physics::surfaces::{layer, mask};
...
fn surface_index_matches_the_javascript_surface_names_order() {
    use axiom_shmup::physics::surfaces::surface_index;
...
fn guess_surface_matches_the_javascript_keyword_table() {
    use axiom_shmup::physics::surfaces::guess_surface;
