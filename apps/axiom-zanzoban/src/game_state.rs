...
//! takes one recorded move every [`crate::ghost_replay::GHOST_STEP_TICKS`] ticks
...
use crate::actor_state::{ActorId, ActorState};
use crate::coord::GridCoord;
use crate::direction::Direction;
use crate::game_command::{PuzzleStepResult, StepKind};
use crate::ghost_replay::GhostReplay;
...
mod tests {
    use super::*;
    use crate::ghost_replay::GHOST_STEP_TICKS;
    use crate::level_definition::{Button, Door};
