...
use axiom_zanzoban::actor_state::ActorState;
use axiom_zanzoban::game_command::PuzzleCommand;
use axiom_zanzoban::{level_codec, Direction, PuzzleGameState, LEVEL_001_TOML};
...
fn encode_actor(out: &mut Vec<u8>, a: &ActorState) {
    ...
    out.push(match a.kind {
        axiom_zanzoban::actor_state::ActorKind::Player => 0,
        axiom_zanzoban::actor_state::ActorKind::Ghost => 1,
    });
