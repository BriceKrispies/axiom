...
use axiom_claude_of_duty::audio::ambience::{ambient_one_shot, Ambience, AmbienceCue, OneShot};
use axiom_claude_of_duty::audio::dsp::{
...
use axiom_claude_of_duty::audio::foley::{
...
use axiom_claude_of_duty::audio::graph::{
    Automation, AudioGraph, NodeId, NodeKind, Param, ParamRef, Schedule, Sink,
};
use axiom_claude_of_duty::audio::ir::{
    classify_space, generate_ir, IrSpec, Space, SpaceWeights, IR_SPECS,
};
use axiom_claude_of_duty::audio::mixer::{Bus, Mixer};
use axiom_claude_of_duty::audio::spatial::{
    AcquireOpts, RayHit, RayMask, SpatialField, WorldProbe,
};
use axiom_claude_of_duty::audio::system::{
...
use axiom_claude_of_duty::audio::vox::{bark, bark_for, Bark, BarkOpts, BarkRequest};
use axiom_claude_of_duty::audio::weapons::{
...
use axiom_claude_of_duty::engine::{Engine, CAPTURE_SEED};
use axiom_claude_of_duty::registry::Phase;
