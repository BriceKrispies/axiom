...
use axiom_claude_of_duty::fx::atlas::{bake_decal_atlas, bake_particle_atlas};
use axiom_claude_of_duty::fx::decals::{DecalAdd, DecalSystem};
use axiom_claude_of_duty::fx::impacts::spawn_impact;
use axiom_claude_of_duty::fx::particles::{reset_spawn, ParticleLayer, ParticleMode, STRIDE};
use axiom_claude_of_duty::fx::system::FxSystem;
