//! Golden captures for `apps/claude-of-duty/src/materials/surfaces/metal.rs`,
...
use axiom_claude_of_duty::materials::noise::Vec2;
use axiom_claude_of_duty::materials::surfaces::metal::{
...
fn assert_sample(actual: axiom_claude_of_duty::materials::bake::SurfaceSample, expected: &Expected, at: &str) {
...
fn metal_painted_matches_the_javascript_capture() {
    ...
    // capture script uses.
    let tint = axiom_claude_of_duty::materials::noise::Vec3::new(
