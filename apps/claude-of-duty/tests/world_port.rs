...
use axiom_claude_of_duty::world::assembler::{Assembler, ProtoSpec};
use axiom_claude_of_duty::world::ground::build_ground;
use axiom_claude_of_duty::world::kit::{chamfer_box, patch_geometry, trs, wall_panel, weather_prop, WallHole, WallPanelOpts, WallTop};
...
fn assert_worldgeo_matches(name: &str, g: &axiom_claude_of_duty::world::geo::WorldGeo, want: &Value) {
