...
use axiom_shmup::world::assembler::{Assembler, StaticMesh};
use axiom_shmup::world::kit::{
...
fn solid_slabs_matches_the_javascript_across_four_layouts() {
    use axiom_shmup::world::kit::solid_slabs;

    let assert_layout = |name: &str, got: Vec<axiom_shmup::world::kit::SolidSlab>| {
