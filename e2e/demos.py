...
DEMOS = [
    ...
    {"id": "doom", "kind": "windowing3d", "path": "demo.html?id=doom", "canvas": "#axiom-doom-canvas"},
    ...
    {"id": "roomed-puzzle", "kind": "canvas2d_app", "path": "roomed-puzzle/index.html",
     "canvas": "#axiom-puzzle-canvas", "ready_log": "[roomed-puzzle] ready"},
