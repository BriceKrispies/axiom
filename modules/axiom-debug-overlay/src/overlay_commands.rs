...
pub(crate) const OVERLAY_SPECS: &[CommandSpec<OverlayState>] = &[
    CommandSpec { name: "help", summary: "list the available commands", handler: cmd_help },
    CommandSpec { name: "clear", summary: "clear the command output", handler: cmd_clear },
    CommandSpec { name: "overlay.compact", summary: "set density to compact", handler: cmd_compact },
    CommandSpec { name: "overlay.normal", summary: "set density to normal", handler: cmd_normal },
    CommandSpec { name: "overlay.verbose", summary: "set density to verbose", handler: cmd_verbose },
    CommandSpec { name: "overlay.pin", summary: "pin the overlay open", handler: cmd_pin },
    CommandSpec { name: "overlay.unpin", summary: "unpin the overlay", handler: cmd_unpin },
    CommandSpec { name: "overlay.hide", summary: "hide the overlay", handler: cmd_hide },
    CommandSpec {
    ...
    CommandSpec { name: "replay.mark", summary: "record a replay marker (stub)", handler: cmd_replay_mark },
    CommandSpec { name: "perf.mark", summary: "record a performance marker (stub)", handler: cmd_perf_mark },
];
