...
// surface is total before the runtime binds a real authority / matchmaker. The
// test returns the matchmake promise (no banned async/await keyword) so node:test
// awaits it.
