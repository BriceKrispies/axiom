//! # axiom-dev-reload — DOOM browser hot-reload dev server
//!
...
//!
//! 1. **Serve static files** for the DOOM browser app (`index.html`, the wasm
...
fn main() {
    ...
    println!("axiom-dev-reload — DOOM browser hot-reload dev server");
