...
//!
//! It builds + serves the gallery, drives a demo (default `burnt-rubber`) headlessly
...
//!
//! ```text
//! cargo run -p axiom-render-bench -- --demo burnt-rubber --backend canvas2d --duration 10
//! cargo run -p axiom-render-bench -- --demo burnt-rubber --backend canvas2d --debug --json
//! ```
//!
...
fn help() -> String {
    "axiom-render-bench — build+serve the gallery, walk a demo, report FPS + phases\n\
     \n\
     --demo <name>        demo to benchmark (default: burnt-rubber)\n\
